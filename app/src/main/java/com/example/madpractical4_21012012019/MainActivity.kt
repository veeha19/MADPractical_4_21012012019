package com.example.madpractical4_21012012019
...
import com.example.madpractical4_21012012019.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.buttonBrowse.setOnClickListener {
            Intent(Intent.ACTION_VIEW).setData(Uri.parse("https://sites.google.com/ganpatuniversity.ac.in/odd22/5sem"))
